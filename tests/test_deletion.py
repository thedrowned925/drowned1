...
class FakeClient:
    ...
    def __init__(self,catalog):
        self.catalog=catalog; self.releases={}; self.files=set(); self.deleted_releases=[]; self.deleted_files=[]; self.catalog_writes=0; self.fail_delete=False
...
class DeletionTests(unittest.TestCase):
    ...
    def test_delete_game_removes_releases_metadata_artwork_and_catalog(self):
    ...
    def test_retry_treats_missing_release_as_already_deleted(self):
